      ...
      <div className="relative group">
        <FormLabel
          className={`
            ...
            ${
              hasValue
                ? 'text-sm -translate-y-7 left-3 bg-background px-px text-border group-has-disabled:z-100'
                : ""
            }
          `}
        >
        ...
        <Input
				ref={ref}
          className={`rounded-lg border-2 border-border/40 dark:border-muted-foreground/30 bg-background dark:bg-background shadow-none pt-5 pb-4 ${className}`}
          {...props}
        />
      </div>
    );
