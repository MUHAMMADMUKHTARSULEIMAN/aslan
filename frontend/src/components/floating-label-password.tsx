    ...
    return (
        ...
        >
          {label}
				...
				<Button disabled={isDisabled} size="icon" type="button" onClick={() => setVisible((prev) => !prev)} className="absolute right-0.5 top-0.5 bg-background hover:bg-input dark:hover:bg-muted/40 text-border dark:text-muted-foreground-fifty peer-hover:bg-card peer-focus:bg-card p-[5px] rounded-[12px] rounded-l-none cursor-pointer shadow-none">
				{
					visible
